...
public class TestBase {
	...
	public void init() {
		...
		String currentDir = System.getProperty("user.dir") + "//Reports//orangehrm_" + Helper.getCurrentDateTime()
				+ ".html";
	...
	public void setUP(@Optional("Chrome") String browser) {
		...
		if (browser.equals("Chrome")) {
			...
			System.out.println("Browser doesn't match with expected browser launch");
		}
